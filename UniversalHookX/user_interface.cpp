...
bool custom_interface::tab(const char* label, bool selected)
{
    ...
    window->DrawList->AddRect(ImVec2(10, 10), ImVec2(100, 100), IM_COL32(255, 0, 0, 255), 0.0f, ImDrawCornerFlags_All, 10.0f);
...
bool custom_interface::subtab(const char* label, bool selected)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Min.x, rect.Min.y + 22), ImVec2(rect.Max.x, rect.Max.y), ImColor(10, 104, 255, it_anim->second.active_rect_alpha));
